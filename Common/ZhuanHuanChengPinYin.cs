...
namespace Common
{
    public sealed class ZhuanHuanChengPinYin
    {
        /**/
        /// <summary>  
        /// 包含字符 ASC 码的整形数组。  
        ...
        public static string Convert(string chs, string separator, bool initialCap)
        {
            ...
            // 例外词组  
            foreach (DictionaryEntry de in ZhuanHuanChengPinYin.Phrase)
            {
        ...
        {
            return ZhuanHuanChengPinYin.Convert(chs, separator, false);
        }
        ...
        {
            return ZhuanHuanChengPinYin.Convert(chs, "", initialCap);
        }
        ...
        {
            return ZhuanHuanChengPinYin.Convert(chs, "");
        }
    }
}

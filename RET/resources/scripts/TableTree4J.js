...
function TableTree4J(objectName,tableTree4JDir){
	...
	this.icon ={
	    ...
	    root:this.tableTree4JDir+'img/base.png',
		folder: this.tableTree4JDir + 'img/team.png',
		folderOpen: this.tableTree4JDir + 'img/team.png',
		//node: this.tableTree4JDir + 'img/page.gif',
		node: this.tableTree4JDir + 'img/employee.png',
	...
	TableTree4J.prototype.setImgRootPath=function(path){
	    ...
	    this.icon.root = path+'base.png';
		this.icon.folder = path + 'team.png';
		this.icon.folderOpen = path + 'team.png';
		this.icon.node = path + 'employee.png';
	...
	//close all node
 	...
 	TableTree4J.prototype.openDefault = function () {
 	    this.flowAllNodesOpenOrClose(false, this.rootNode);
 	    for (var i = 0; i < this.rootNode.childNodes.length; i++) {
 	        clickNode(this.rootNode.childNodes[i].id, this);
 	    }
 	}
